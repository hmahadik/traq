...
func (s *ReportsService) GenerateReport(timeRange, reportType string) (*storage.Report, error) {
	// Parse time range
	...
	switch reportType {
	case "standup":
		content, err = s.generateStandupReport(tr)
	case "detailed":
		content, err = s.generateDetailedReport(tr)
	default: // "summary"
		content, err = s.generateSummaryReport(tr)
	}
...
func (s *ReportsService) generateSummaryReport(tr *TimeRange) (string, error) {
...
func (s *ReportsService) generateDetailedReport(tr *TimeRange) (string, error) {
	var sb strings.Builder
...
func (s *ReportsService) generateStandupReport(tr *TimeRange) (string, error) {
	var sb strings.Builder
